...
const handleGetSpecificFormSpecialTalentPoolScholarshipData = async (
    request,
    context
) => {
    // Connect to MongoDB
    ...
    if (!id || !dataId) {
        return sendResponse(
            ...
            `Talent pool scholarship ID and talent pool scholarship data ID are required.`,
            {},
            {},
            request
        );
    ...
    if (!document || !document.data) {
        return sendResponse(
            ...
            `Talent pool scholarship form entry with ID "${id}" not found.`,
            {},
            {},
            request
        );
...
export const GET = asyncHandler(
    handleGetSpecificFormSpecialTalentPoolScholarshipData
);
